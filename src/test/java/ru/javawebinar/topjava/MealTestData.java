...
public class MealTestData {
    ...
    public static final String END_TIME = "22:00:00";
    ...
    public static final List<MealTo> mealsTo = MealsUtil.getTos(MealTestData.meals, SecurityUtil.authUserCaloriesPerDay());
